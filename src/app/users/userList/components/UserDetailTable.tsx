...
import styles from './UserDetailTable.module.css';
import { users } from '../../../data/users';
import Tabs from '../../../components/layout/tabs/userDetailTabs/UserDetailTabs';
...
export default function UserDetailTable() {
  ...
  return (
    <div className={styles.container}>
      {/* Sekmeler */}
      <Tabs activeTabIndex={0} /> {/* ilk sekme aktif olsun */}
      {/* Form */}
